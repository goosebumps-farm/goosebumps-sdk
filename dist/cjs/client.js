...
class GooseClient {
    ...
    depositToBucketTank(txb, currentAddress, vault, compoundRequest, depositRequest, bp, oracle, bktTreasury) {
        ...
        return txb.moveCall({
            ...
            typeArguments: [],
            arguments: [txb.object(vault), txb.object(compoundRequest), txb.object(depositRequest), txb.object(bp), txb.object(oracle), txb.object(bktTreasury), txb.object(utils_1.SUI_CLOCK_OBJECT_ID)],
        });
    }
    createBond(txb, compoundRequest, depositRequest, currentAddress) {
        ...
        return txb.moveCall({
            ...
            typeArguments: [],
            arguments: [txb.object(utils_1.SUI_CLOCK_OBJECT_ID), txb.object(compoundRequest), txb.object(depositRequest)],
        });
    }
    ...
    compoundToBucket(txb, currentAddress, vault, compoundRequest, bp, oracle, bktTreasury) {
        ...
        */
        ...
        return txb.moveCall({
            ...
            typeArguments: [],
            arguments: [txb.object(vault), txb.object(compoundRequest), txb.object(bp), txb.object(oracle), txb.object(bktTreasury), txb.object(utils_1.SUI_CLOCK_OBJECT_ID)],
        });
    }
    approveBond(txb, currentAddress, nft, compoundRequest, vault, manager) {
        ...
        */
        ...
        return txb.moveCall({
            ...
            typeArguments: [],
            arguments: [txb.object(nft), txb.object(compoundRequest), txb.object(vault), txb.object(manager), txb.object(utils_1.SUI_CLOCK_OBJECT_ID)],
        });
    }
...
exports.GooseClient = GooseClient;
